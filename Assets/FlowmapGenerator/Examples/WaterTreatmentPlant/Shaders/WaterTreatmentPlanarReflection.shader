Shader "FlowmapGenerator/WaterTreatmentPlant/WaterPlanarReflection" {
	Properties {
...
//			flow normal map
			...
			half3 reflection = tex2D(_ReflectionTex, (IN.screenPos.xy / IN.screenPos.w) + o.Normal * 0.02).rgb;
						 			
			o.Albedo = diffuse;
			o.Gloss = _SpecColor.rgb * lerp(1, 0.05, foam.a);
			o.Emission = reflection * o.Gloss * fresnel;
