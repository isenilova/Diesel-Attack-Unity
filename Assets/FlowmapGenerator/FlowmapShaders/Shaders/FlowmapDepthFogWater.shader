Shader "FlowmapGenerator/Depth Fog/Water" {
	Properties {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutput o) {		
			...
			o.Albedo = tex2D (_MainTex, flowUV).rgb * _Color.rgb * backgroundLerp;
			SpecCube (o, _SpecColor * backgroundLerp, IN.viewDir, WorldReflectionVector(IN, o.Normal), _Shininess, _Cube);		
			o.Emission = lerp(background, o.Emission, backgroundLerp);
			o.Alpha = 1;
		}
		ENDCG
	} 
