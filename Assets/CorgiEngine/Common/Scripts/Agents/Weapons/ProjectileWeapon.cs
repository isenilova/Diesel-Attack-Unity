...
{		
	...
	public class ProjectileWeapon : Weapon 
	{
		...
		protected override void WeaponUse()
		{
            ...
            //Debug.Log("WE SHOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOT");
		...
		public virtual GameObject SpawnProjectile(Vector3 spawnPosition,bool triggerObjectActivation=true)
		{
            ...
            if (projectile != null)
            {
                ...
                {
                    projectile.SetDirection(transform.up, Quaternion.Euler(0,0,90)/*transform.rotation*/);
                }
                else if (Input.GetKey(KeyCode.DownArrow))
                    projectile.SetDirection(-transform.up, Quaternion.Euler(0, 0, -90));
                else
